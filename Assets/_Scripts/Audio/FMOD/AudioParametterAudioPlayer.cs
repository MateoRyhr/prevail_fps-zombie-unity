...
//     {
//         EventInstance soundInstance = SetParametter(sound);
...
//     EventInstance SetParametter(Sound sound)
//     {
//         // Debug.Log($"Parametter name: {_parametter.TypeName}");
//         // Debug.Log($"Parametter type: {_parametter.Type}");
